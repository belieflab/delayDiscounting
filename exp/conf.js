...
// Experiment Name
const experimentName = "Delay Discounting"; // Name displayed in the browser title bar
const experimentAlias = "dd"; // Unique identifier for the experiment, used in data saving
