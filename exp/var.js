...
// const magnitudeNow   = ['medium', 'medium', ''];
const magnitudeAfter = ['medium', 'large', 'small', 'large', 'small', 'medium', 'small', 'medium', 'large', 'medium', 'small', 'large', 'small', 'medium', 'large', 'medium', 'large', 'small', 'large', 'small', 'medium', 'small', 'large', 'medium', 'large', 'small', 'medium'];
...
let main_stimuli = [];
    for (let i =0;i<stim_array.length;i++) {
        main_stimuli.push({stimulus: stim_array[i], data: {test_part: 'experiment', magnitude: magnitudeAfter[i]}})
}
